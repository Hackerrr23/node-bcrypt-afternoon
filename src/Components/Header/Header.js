...
export default class Header extends Component {
  ...
  register() {
    ...
    axios.post("/auth/register", {username:username,password:password,isAdmin:isAdmin})
    .then(response => {
      this.setState({
        username: "",password:""
      });
      ...
      alert(err.response.request.response)//only way to access response if status code is not 201
    })
  }
